        ...
        public async Task<IActionResult> Index(string cityId)
        {
            if (!string.IsNullOrEmpty(cityId))
            {
                ...
                var request = new HttpRequestMessage
                {
                    ...
                    RequestUri = new Uri($"https://booking-com15.p.rapidapi.com/api/v1/hotels/searchHotels?dest_id={cityId}&search_type=CITY&arrival_date=2024-03-11&departure_date=2024-03-15&adults=1&children_age=0%2C17&room_qty=1&page_number=1&languagecode=en-us&currency_code=AED"),
                    Headers =
    {
