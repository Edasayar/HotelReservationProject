...
namespace HotelProject.WebUI.Controllers
{
    public class AdminContactController : Controller
    {
        ...
        public async Task<IActionResult> Inbox()
        {
            ...
            var responseMessage2 = await client2.GetAsync("http://localhost:5027/api/Contact/GetContactCount");

            var client3 = _httpClientFactory.CreateClient();
            var responseMessage3 = await client3.GetAsync("http://localhost:5027/api/SendMessage/GetSendMessageCount");
