...
namespace HotelProject.WebUI.Controllers
{
    public class AdminAboutController : Controller
    {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"http://localhost:5027/api/About/{id}");
        ...
        public async Task<IActionResult> UpdateAbout(AboutUpdateDto aboutUpdateDto)
        {
            ...
            var responseMessage = await client.PutAsync("http://localhost:5027/api/About/", content);
